...
class Game {
  ...
  renderLevelUpMessage(ctx) {
    ...
    ctx.font = '20px PressStart';
    ctx.fillText('click to', 400, 150);
    ctx.font = '36px PressStart';
    ctx.fillText(`START LEVEL ${this.level}`, 400, 200);
    ctx.font = '16px PressStart';
    ctx.fillText(cityText, 400, 250);
    ctx.fillText(' + ', 400, 275);
    ctx.fillText(missileText, 400, 300);
  }
  ...
  renderEndGameMessage(ctx) {
    ...
    ctx.font = '40px PressStart';
    ctx.fillText(`Final Score ${this.score.total}`, 400, 200);
    ctx.font = '20px PressStart';
